...
| **6 — native reader & release** | .ad2cp binary reader; registration prep (CI + Aqua done in Phase 5) | binary reader matches MIDAS netCDF on M38 (velocities bit-scaled identical); General registry checklist |
