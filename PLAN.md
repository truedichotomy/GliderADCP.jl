...
real time. Slocum ingestion (via the user's SlocumIO.jl: `m_water_vx/vy`,
...
Layer 1  io/nortek_netcdf.jl     load_ad2cp(paths): Config + Data/Average + Data/AverageBT
         ...
         io/slocum.jl            via SlocumIO.jl / CSV exports
